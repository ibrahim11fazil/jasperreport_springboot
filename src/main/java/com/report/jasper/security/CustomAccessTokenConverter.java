package com.report.jasper.security;
...
public class CustomAccessTokenConverter implements AccessTokenConverter, JwtAccessTokenConverterConfigurer {
    ...
    public OAuth2Authentication extractAuthentication(Map<String, ?> map) {
        ...
        if (includeGrantType && map.containsKey(GRANT_TYPE))
            parameter.put(GRANT_TYPE, (String) map.get(GRANT_TYPE));
        ...
        OAuth2Request request = new OAuth2Request(parameter, clientId, authorities, true, scope, resourceIds, null, null, null);
